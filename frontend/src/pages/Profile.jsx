                ...
                <div className="max-w-4xl mx-auto animate-fade-in-up">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div className="md:col-span-1">
                            <div className="flex flex-col items-center p-8 text-center bg-white border border-gray-100 rounded-3xl shadow-sm relative overflow-hidden group">
                                ...
                                <div className="relative mb-6">
                                    <div className="h-32 w-32 rounded-full overflow-hidden border-4 border-white ring-2 ring-brand-yellow shadow-xl">
                                        <img
                                    ...
                                    <button className="absolute bottom-0 right-0 bg-brand-yellow p-2 rounded-full text-white shadow-lg hover:scale-110 transition-transform">
                                ...
                                <div className="w-full mt-8 space-y-3 relative z-10">
                                    <button
                                        ...
                                        className={`w-full py-3 rounded-xl font-bold transition-all ${isEditing
                                            ...
                                            : 'bg-brand-yellow text-white hover:bg-blue-700'}`}
                                    >
                        ...
                        <div className="md:col-span-2 space-y-8">
                                ...
                                <form onSubmit={handleSave}>
                                        ...
                                        <div>
                                            ...
                                            <div className="relative">
                                                <input
                                                    ...
                                                    disabled={!isEditing}
                                                    className={`w-full bg-gray-50 border border-gray-100 rounded-2xl px-4 py-3 text-gray-900 focus:outline-none focus:border-brand-yellow transition-all ${!isEditing && 'opacity-60 cursor-not-allowed'}`}
                                                />
                                            </div>
                                        </div>
                                        <div>
                                    ...
                                    {isEditing && (
                                        <div className="flex justify-end pt-4 border-t border-gray-100">
                                            <button
                                                type="submit"
                                                className="bg-green-50 text-green-600 px-8 py-3 rounded-xl font-bold hover:bg-green-100 transition-colors flex items-center border border-green-100"
                                            >
                            ...
                            <div className="bg-white border border-gray-100 rounded-3xl p-8 relative overflow-hidden shadow-sm">
                                <h3 className="text-xl font-bold text-gray-900 mb-6 flex items-center">
                                    <Lock className="mr-3 h-5 w-5 text-red-500" /> Security Settings
                                </h3>
                                <div className="space-y-4">
                                    <div className="flex items-center justify-between p-4 bg-gray-50 rounded-2xl border border-gray-100 hover:border-brand-yellow/30 transition">
                                        <div>
                                            <p className="font-bold text-gray-900">Two-Factor Authentication</p>
                                            <p className="text-sm text-gray-500">Add an extra layer of security to your account.</p>
                                        </div>
                                        <button className="px-4 py-2 bg-white text-gray-900 text-sm font-bold rounded-xl border border-gray-200 hover:bg-gray-50 transition">Enable</button>
                                    </div>
                                    <div className="flex items-center justify-between p-4 bg-gray-50 rounded-2xl border border-gray-100 hover:border-brand-yellow/30 transition">
                                        <div>
                                            <p className="font-bold text-gray-900">Change Password</p>
                                            <p className="text-sm text-gray-500">Update your password regularly to stay safe.</p>
                                        </div>
                                        <button className="px-4 py-2 bg-white text-gray-900 text-sm font-bold rounded-xl border border-gray-200 hover:bg-gray-50 transition">Update</button>
                                    </div>
                                </div>
                            </div>
                        </div>
