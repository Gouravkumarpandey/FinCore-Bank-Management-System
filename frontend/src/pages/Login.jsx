                    ...
                    <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                        ...
                        <div className="flex items-center justify-between">
                            <label className="flex items-center cursor-pointer">
                                <input type="checkbox" className="h-4 w-4 rounded border-gray-600 text-brand-yellow focus:ring-brand-yellow bg-gray-800" />
                                <span className="ml-2 text-sm text-gray-400">Remember me</span>
                            </label>
                            <a href="#" className="text-sm font-medium text-brand-yellow hover:text-yellow-400">Forgot password?</a>
                        </div>
                        ...
                        <div className="text-center mt-6">
                            <p className="text-gray-500 font-medium">
                                ...
                                <Link to="/signup" className="text-brand-yellow hover:text-yellow-400 font-bold hover:underline">
                                    Sign up for free
                                </Link>
                            </p>
                            <div className="mt-4">
